        ...
        strings: {
            ...
            workflows: {
                ...
                steps: {
                    ...
                    run_if_section_title: "Run conditions",
                    run_if_title: "Run if condition met",
                    run_if_description: "You can enter any valid Go template. You can refer to Env Vars and more, see <a href='<url>' target='_blank'>the docs for details.</a>",
                    run_if_unconditional: "This step will always run",
                    run_if_expression_true: "This step will only run if the expression evaluates to “true”",
                    run_if_previous_steps_succeeded: "This step will only run if all previous steps succeeded",
                    run_if_previous_steps_succeeded_and_expression_true: "This step will only run if all previous steps succeeded and the expression evaluates to “true”",
                    is_always_run_title: "Run if previous step(s) failed",
