  ...
  >
    {!hasTriggers && (
      <Notification status="warning">
        No triggers are currently set for this app
      </Notification>
    )}
    <Box display="flex" flexDirection="column" gap="8">
      ...
      <Text>
        Triggers are required in order to run builds automatically. To set one
        up, you need to specify:{" "}
      </Text>
      <List>
        <ListItem>
        ...
        <ListItem>
          the <strong>branch</strong> of your repository: for example, master or
          dev.
        </ListItem>
      </List>
      <Text>
