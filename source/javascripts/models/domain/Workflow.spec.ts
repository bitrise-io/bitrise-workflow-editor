import {
  extractAfterRunChain,
  extractAllWorkflowChains,
  extractBeforeRunChain,
  extractChainableWorkflows,
  extractUsedByWorkflows,
  extractWorkflowChain,
  Workflows,
} from './Workflow';

describe('Workflow', () => {
  describe('extractBeforeRunChain', () => {
    it('should return an empty array when there are no workflows', () => {
      const id = 'wf-1';
      const workflows: Workflows = {};

      const result = extractBeforeRunChain(workflows, id);
  ...
  describe('extractAfterRunChain', () => {
    it('should return an empty array when there are no workflows', () => {
      const id = 'wf-1';
      const workflows: Workflows = {};

      const result = extractAfterRunChain(workflows, id);
  ...
  describe('extractWorkflowChain', () => {
    it('should return an empty array when there are no workflows', () => {
      const id = 'wf-1';
      const workflows: Workflows = {};

      const result = extractWorkflowChain(workflows, id);
  ...
  describe('extractAllWorkflowChains', () => {
    it('should return an empty object when there are no workflows', () => {
      const workflows: Workflows = {};

      const result = extractAllWorkflowChains(workflows);
  ...
  describe('extractChainableWorkflows', () => {
    it('should return an empty array when there are no workflows', () => {
      const id = 'wf-1';
      const workflows: Workflows = {};

      const result = extractChainableWorkflows(workflows, id);
  ...
  describe('extractUsedByWorkflows', () => {
    it('should return an empty array when there are no workflows', () => {
      const id = 'wf-1';
      const workflows: Workflows = {};
