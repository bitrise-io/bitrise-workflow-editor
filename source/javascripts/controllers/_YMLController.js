...
(function () {
  ...
  angular
    ...
    .controller(
      "YMLController",
      function ($scope, $rootScope, $timeout, appService, requestService) {
        var viewModel = this;
        ...
        viewModel.init = function () {
          ...
          if (requestService.isWebsiteMode()) {
            const fetchPipelineConfig = appService
              .getPipelineConfig()
              .then(function () {
                ...
                viewModel.ymlSettings.isModularYamlSupported =
                  appService.pipelineConfig.modularYamlSupported;
                viewModel.ymlSettings.isYmlSplit =
                  appService.pipelineConfig.split;
              });
          }
        ...
        viewModel.onConfigSourceChangeSaved = function (
          usesRepositoryYml,
          ymlRootPath,
        ) {
          viewModel.isEditorLoading = true;
