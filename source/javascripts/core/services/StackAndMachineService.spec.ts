...
describe('StackAndMachineService', () => {
  describe('prepareStackAndMachineSelectionData', () => {
          ...
          options: [
            {
              ...
              subtitle: 'US: Mac Medium US 4 CPU 8 GB RAM\nEU: Mac Medium EU 6 CPU 12 GB RAM',
              isDisabled: false,
              value: 'g2.mac.medium',
            },
            {
              ...
              subtitle: 'US: Mac Large US 8 CPU 16 GB RAM\nEU: Mac Large EU 12 CPU 20 GB RAM',
              isDisabled: true,
              value: 'g2.mac.large',
            },
          ],
    ...
    it('returns region-specific subtitles for machine resource classes when region is specified', () => {
      ...
      expect(machineTypeOption?.subtitle).toBe('Mac Medium EU 6 CPU 12 GB RAM');
    });
