import { Workflow, Workflows } from '@/core/models/Workflow';
...
function getBeforeRunChain(workflows: Workflows, id: string): string[] {
  ...
  return ids.reduce((mergedIds: string[], currentId: string) => {
...
function getAfterRunChain(workflows: Workflows, id: string): string[] {
  ...
  return ids.reduce<string[]>((mergedIds: string[], currentId: string) => {
    if (workflows[currentId]) {
      return [
        ...mergedIds,
        ...getBeforeRunChain(workflows, currentId),
