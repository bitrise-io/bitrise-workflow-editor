        ...
        options?.privateCloud === 'no-machines'
          ...
          : {
              osx: {
                ...
                machine_types: {
                  'm1.medium': {
                    available_on_stacks: ['osx-xcode-15.0.x', 'osx-xcode-16.0.x'],
                    name: 'M1 Medium',
                    chip: 'apple',
                    cpu_count: '4 vCPU',
                  ...
                  'm2.medium': {
                    available_on_stacks: ['osx-xcode-15.0.x', 'osx-xcode-16.0.x', 'mixed-stack'],
                    name: 'M2 Pro Medium',
                    chip: 'apple',
                    cpu_count: '4 vCPU',
                  ...
                  'm2.x-large': {
                    available_on_stacks: ['osx-xcode-16.0.x', 'mixed-stack'],
                    name: 'M2 Pro X Large',
                    chip: 'apple',
                    cpu_count: '12 vCPU',
                    cpu_description: '3.7GHz',
              ...
              linux: {
                ...
                machine_types: {
                  ...
                  'amd.medium': {
                    available_on_stacks: ['ubuntu-noble-24.04-bitrise-2025', 'mixed-stack'],
            ...
            promoted_machine_types: [
              {
                ...
                ram: '32 GB RAM',
                os_id: 'osx',
                available_on_stacks: ['osx-xcode-16.0.x'],
              },
              {
                id: 'machine-y2',
                name: 'Machine Y2',
