  ...
  return http.get(StacksAndMachinesApi.getStacksAndMachinesPath(':appSlug'), async () => {
    ...
    > = {
      'osx-xcode-16': {
        ...
        available_machines: options?.isLegacyDedicated
          ? []
      ...
      'osx-xcode-15': {
        ...
        available_machines: options?.isLegacyDedicated ? [] : ['m1.medium', 'm1.large', 'm2.medium', 'm2.large'],
        rollback_version: {
          'm1.medium': {
            paying: '2-82-0',
          },
    ...
    return HttpResponse.json({
      running_builds_on_private_cloud: Boolean(options?.isDedicated),
