const workflowSelectElement = (workflowName) =>
  `[data-e2e-tag="workflow-selector-option-${workflowName}"]`;
const stepSelector = (index) =>
  `.workflow.edited .steps ul li:eq(${index - 1}) button.step`;
...
export const elements = {
  ...
  "Step Version Branch Icon":
    '[data-e2e-tag="step-version-details__branch-icon"]',
  "Step Version Update Icon":
    '[data-e2e-tag="step-version-details__update-icon"]',
  "Selected Step First Input": ".selected-step .input:eq(0)",
  "Selected Step First Input Title":
    ".selected-step .input .input-info .title span:eq(0)",
  "Selected Step First Input Sensitive Badge":
    ".selected-step .input .input-info .sensitive:eq(0)",
  "Selected Step First Input Required Badge":
    ".selected-step .input .input-info .required:eq(0)",
  "Selected Step First Input Change Button":
    ".selected-step .input .input-change:eq(0)",
  "Selected Step First Input Description":
    ".selected-step .input:eq(0) .input-description",
  "Insert Variable Popup": "#insert-variable-popup-body",
  "Selected Step Second Input Category Toggle Button":
    ".selected-step .input-category:eq(1) .toggle-category",
  "Selected Step Second Input Category Title":
    ".selected-step .input-category:eq(1) .category-name",
  "Selected Step Second Input Category Inputs":
    ".selected-step .input-category:eq(1) .inputs-list",
  ...
  "Variables for insert":
    "#insert-variable-popup-body .variable-source:has(li)",
  ...
  "First After Workflow Name":
    ".workflow:nth-last-child(2) .icons-and-name .workflow-name",
  "Last After Workflow Name":
    ".workflow:last-child .icons-and-name .workflow-name",
  ...
  "wf3 workflow rename field": `${workflowSelectElement("wf3")} [data-e2e-tag="workflow-selector-item-name-input"] input`,
  ...
  "Change Workflow execution order button":
    "button:contains('Change Workflow execution order')",
  "Rearrange popup": "#rearrange-workflow-chain-popup-body",
  "Workflow chain": ".workflow-chain",
  "Workflow chain selected workflow":
    "#rearrange-workflow-chain-popup-body .workflow-chain .selected",
  "Workflow chain before workflows": ".workflow-chain .before-run",
  "Workflow chain before wf4 workflow":
    "#rearrange-workflow-chain-popup-body .workflow-chain .before-run li:first",
  "Workflow chain after workflows": ".workflow-chain .after-run",
  "Workflow chain first after wf5 workflow":
    ".workflow-chain .after-run li:nth(0)",
  "Workflow chain second after wf5 workflow":
    ".workflow-chain .after-run li:nth(1)",
  "Workflow chain after wf6 workflow": ".workflow-chain .after-run li:nth(2)",

  "Step source link": "a.source",

  "Insert variable element called BITRISE_SOURCE_DIR":
    inputVariableSelector("BITRISE_SOURCE_DIR"),
  "Insert variable element called BITRISE_SOURCE_DIR source": `${inputVariableSelector("BITRISE_SOURCE_DIR")} em`,
  "Insert variable element called BITRISE_DEPLOY_DIR":
    inputVariableSelector("BITRISE_DEPLOY_DIR"),
  "Insert variable element called BITRISE_DEPLOY_DIR source": `${inputVariableSelector("BITRISE_DEPLOY_DIR")} em`,
  "Insert variable element called BITRISE_BUILD_STATUS": inputVariableSelector(
  ...
  "Insert variable element called BITRISE_TRIGGERED_WORKFLOW_ID":
    inputVariableSelector("BITRISE_TRIGGERED_WORKFLOW_ID"),
  "Insert variable element called BITRISE_TRIGGERED_WORKFLOW_ID source": `${inputVariableSelector(
    "BITRISE_TRIGGERED_WORKFLOW_ID",
  )} em`,
  "Insert variable element called BITRISE_TRIGGERED_WORKFLOW_TITLE":
    inputVariableSelector("BITRISE_TRIGGERED_WORKFLOW_TITLE"),
  ...
  "Insert variable element called VERYSECRET":
    inputVariableSelector("VERYSECRET"),
  ...
  "Insert variable element called SLACK_WEBHOOK":
    inputVariableSelector("SLACK_WEBHOOK"),
  "Insert variable element called SLACK_WEBHOOK source": `${inputVariableSelector("SLACK_WEBHOOK")} em`,
  "Insert variable element called ACCESS_KEY":
    inputVariableSelector("ACCESS_KEY"),
  "Insert variable element called ACCESS_KEY source": `${inputVariableSelector("ACCESS_KEY")} em`,
  "Insert variable element called GITHUB_TOKEN":
    inputVariableSelector("GITHUB_TOKEN"),
  "Insert variable element called GITHUB_TOKEN source": `${inputVariableSelector("GITHUB_TOKEN")} em`,
  "Insert variable element called COMPANY_NAME":
    inputVariableSelector("COMPANY_NAME"),
  ...
  "Step Title Edit Box": `r-step-config .chakra-tabs__tab-panel:nth-child(2) input[name="properties.name"]`,
  "Step Version Selector": `r-step-config .chakra-tabs__tab-panel:nth-child(2) select[name="properties.version"]`,
...
export const selector = (elementSelector) =>
  elements[elementSelector] || elementSelector;
