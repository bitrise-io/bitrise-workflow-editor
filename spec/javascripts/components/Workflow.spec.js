describe("Workflow", function () {
  ...
  describe("create", function () {
    ...
    it("should configure Workflow", function () {
      ...
      expect(workflow.workflowConfig.envs[0]["RED-ENV-VAR"]).toBe(
        "RED-ENV-VAR-VALUE",
      );
    });
  });
  ...
  describe("workflowChain", function () {
    ...
    it("should include before and after workflows", function () {
      ...
      expect(
        redWorkflow.workflowChain([redWorkflow, greenWorkflow, blueWorkflow]),
      ).toContain(greenWorkflow);
      expect(
        redWorkflow.workflowChain([redWorkflow, greenWorkflow, blueWorkflow]),
      ).toContain(blueWorkflow);
    });
    ...
    it("should include before and after workflows recursively", function () {
      ...
      expect(
        redWorkflow.workflowChain([
          redWorkflow,
          greenWorkflow,
          blueWorkflow,
          yellowWorkflow,
        ]),
      ).toContain(yellowWorkflow);
    });
  ...
  describe("isLoopSafeRunForWorkflow", function () {
    ...
    it("should return false if Workflow references self", function () {
      expect(
        redWorkflow.isLoopSafeRunForWorkflow(redWorkflow, [
          redWorkflow,
          greenWorkflow,
          blueWorkflow,
        ]),
      ...
      expect(
        greenWorkflow.isLoopSafeRunForWorkflow(greenWorkflow, [
          redWorkflow,
          greenWorkflow,
          blueWorkflow,
        ]),
      ...
      expect(
        blueWorkflow.isLoopSafeRunForWorkflow(blueWorkflow, [
          redWorkflow,
          greenWorkflow,
          blueWorkflow,
        ]),
    ...
    it("should return false if Workflow references self through another Workflow", function () {
      ...
      expect(
        redWorkflow.isLoopSafeRunForWorkflow(greenWorkflow, [
          redWorkflow,
          greenWorkflow,
          blueWorkflow,
        ]),
    ...
    it("should return true if Workflow not references self", function () {
      ...
      expect(
        blueWorkflow.isLoopSafeRunForWorkflow(redWorkflow, [
          redWorkflow,
          greenWorkflow,
          blueWorkflow,
        ]),
      ...
      expect(
        greenWorkflow.isLoopSafeRunForWorkflow(redWorkflow, [
          redWorkflow,
          greenWorkflow,
          blueWorkflow,
        ]),
      ...
      expect(
        blueWorkflow.isLoopSafeRunForWorkflow(greenWorkflow, [
          redWorkflow,
          greenWorkflow,
          blueWorkflow,
        ]),
