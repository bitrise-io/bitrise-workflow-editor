describe("SemverService", () => {
  ...
  describe("reverseSort", () => {
    it("should return 1, if first parameter is smaller", () => {
      const result = semverService.reverseSort("1.9.7", "1.10.0");
    ...
    it("should return -1, if first parameter is bigger", () => {
      const result = semverService.reverseSort("1.10.0", "1.9.7");
  ...
  describe("sort", () => {
    it("should return -1, if first parameter is smaller", () => {
      const result = semverService.sort("1.9.7", "1.10.0");
    ...
    it("should return 1, if first parameter is bigger", () => {
      const result = semverService.sort("1.10.0", "1.9.7");
